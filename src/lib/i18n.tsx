...
const dict: Dict = {
  ...
  // Channels / assistants
  channelsNav: { en: "Channels", tr: "Kanallar" },
  channelsTitle: { en: "Channel assistants", tr: "Kanal asistanları" },
  channelsSubtitle: {
    en: "Choose an assistant for each channel. ISURA will send briefings there — send only, never read.",
    tr: "Her kanal için bir asistan seçin. ISURA brifingleri oraya gönderir — yalnızca gönderir, okumaz.",
  },
  channelsAssistant: { en: "Assistant", tr: "Asistan" },
  channelsTarget: { en: "Destination", tr: "Hedef" },
  channelsEnabled: { en: "Enabled", tr: "Etkin" },
  channelsConnectNeeded: { en: "Connection required to send", tr: "Göndermek için bağlantı gerekli" },
  channelsConnected: { en: "Ready to send", tr: "Göndermeye hazır" },
  channelsSend: { en: "Send briefing now", tr: "Brifingi şimdi gönder" },
  channelsSending: { en: "Sending…", tr: "Gönderiliyor…" },
  channelsSentOk: { en: "Briefing sent", tr: "Brifing gönderildi" },
  channelsSendFailed: { en: "Could not send to some channels", tr: "Bazı kanallara gönderilemedi" },
  channelsNoneEnabled: { en: "Enable at least one channel first", tr: "Önce en az bir kanalı etkinleştirin" },
  channelsSaved: { en: "Saved", tr: "Kaydedildi" },
  ch_email: { en: "Email", tr: "E-posta" },
  ch_whatsapp: { en: "WhatsApp", tr: "WhatsApp" },
  ch_slack: { en: "Slack", tr: "Slack" },
  ch_telegram: { en: "Telegram", tr: "Telegram" },
  ph_email: { en: "name@company.com", tr: "ad@sirket.com" },
  ph_whatsapp: { en: "+905551234567", tr: "+905551234567" },
  ph_slack: { en: "#operations", tr: "#operasyon" },
  ph_telegram: { en: "Chat ID (e.g. 123456789)", tr: "Chat ID (ör. 123456789)" },
  asst_operational: { en: "Operational assistant", tr: "Operasyonel asistan" },
  asst_operational_d: { en: "Full briefing with risks and decisions.", tr: "Riskler ve kararlarla tam brifing." },
  asst_concise: { en: "Concise assistant", tr: "Kısa özet asistanı" },
  ...
  navObjectives: { en: "Objectives", tr: "Hedefler" },
  objTitle: { en: "Objectives", tr: "Hedefler" },
  objTagline: {
    en: "Describe what you want. ISURA plans it, step by step.",
    tr: "İstediğinizi söyleyin. ISURA adım adım planlar.",
  },
  objInputPlaceholder: {
    en: "e.g. Find 500 charter schools in Florida and prepare an outreach campaign",
    tr: "örn. Florida'da 500 charter okul bul ve bir tanıtım kampanyası hazırla",
  },
  objCreate: { en: "Plan this", tr: "Bunu planla" },
  objPlanning: { en: "Planning…", tr: "Planlanıyor…" },
  objSpeak: { en: "Speak your objective", tr: "Hedefini söyle" },
  objListening: { en: "Listening…", tr: "Dinleniyor…" },
  objEmptyTitle: { en: "No objectives yet", tr: "Henüz hedef yok" },
  objEmptyBody: {
    en: "Give ISURA a goal in plain language. It breaks it into a plan and coordinates the right agents.",
    tr: "ISURA'ya sade bir dille bir hedef verin. Onu bir plana böler ve doğru ajanları koordine eder.",
  },
  objTasks: { en: "steps", tr: "adım" },
  objDone: { en: "done", tr: "tamamlandı" },
  objBack: { en: "All objectives", tr: "Tüm hedefler" },
  objPlan: { en: "Plan", tr: "Plan" },
  objApprove: { en: "Approve", tr: "Onayla" },
  objRun: { en: "Mark running", tr: "Çalışıyor işaretle" },
  objComplete: { en: "Complete", tr: "Tamamla" },
  objSkip: { en: "Skip", tr: "Atla" },
  objReqApproval: { en: "Needs your approval", tr: "Onayınız gerekiyor" },
  objExamples: { en: "Try:", tr: "Deneyin:" },
  taskAgentResearch: { en: "Research Agent", tr: "Araştırma Ajanı" },
  taskAgentSales: { en: "Sales Agent", tr: "Satış Ajanı" },
  taskAgentEmail: { en: "Email Agent", tr: "E-posta Ajanı" },
  taskAgentCrm: { en: "CRM Agent", tr: "CRM Ajanı" },
  taskAgentCalendar: { en: "Calendar Agent", tr: "Takvim Ajanı" },
  taskAgentAnalytics: { en: "Analytics Agent", tr: "Analitik Ajanı" },
  taskAgentKnowledge: { en: "Knowledge Agent", tr: "Bilgi Ajanı" },
  taskAgentDecision: { en: "Decision Agent", tr: "Karar Ajanı" },
  taskAgentPlanner: { en: "Planner", tr: "Planlayıcı" },
